...
@endcan
    <div class="row">
              <div class="col-md-12">
            <h1>Critical Inventiry Status</h1>
        </div>
        <div class="col-md-6">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="3" class="text-muted text-center">Tidak ada produk dengan stok habis.</td>
                </tr>
                @endforelse
            </tbody>
            </table>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="4" class="text-muted text-center">Seluruh produk dalam kondisi aman.</td>
                </tr>
                @endforelse
            </tbody>
            </table>
